...
const arrayOfPeople =[{name: 'Joe', age: 21, favoriteFoods: ['pizza', 'burger']},{name: 'Jane', age: 45, favoriteFoods: ['kiwi', 'starwberries']},{name: 'hamilton', age: 30, favoriteFoods: ['tacos', 'burritos']}]
...
var findPeopleByName = function(personName, done) {
  ...
  Person.find(query,(err,results)=>err ? done(err) : done(null,results))
};
...
var findOneByFood = function(food, done) {
  ...
  Person.findOne(query,(err,result)=>err ? done(err) : done(null,result))
};
...
var findPersonById = function(personId, done) {
  Person.findById(personId,(err,result)=>err ? done(err) : done(null,result))
};
...
var findEditThenSave = function(personId, done) {
  ...
  Person.findById(personId,(err,result)=>{
    ...
    result.save((err,updated)=>err ? done(err) : done(null,updated))                          
    })
};
...
var findAndUpdate = function(personName, done) {
  ...
  Person.findOneAndUpdate(condition,update,options,(err,updated)=> err ? done(err) : done(null,updated))
};
...
var removeById = function(personId, done) {
  ...
  Person.findByIdAndRemove(personId,(err,removed)=> err ? done(err) : done(null,removed))
...
var removeManyPeople = function(done) {
  ...
  Person.remove({name:nameToRemove},(err,removed)=> err ? done(err) : done(null,removed))
};
...
var queryChain = function(done) {
  ...
  Person.find({favoriteFoods:foodToSearch})
    ...
    .limit(2)
    .select('-age')
    .exec((err,result) => err ? done(err) : done(null, result))
};
